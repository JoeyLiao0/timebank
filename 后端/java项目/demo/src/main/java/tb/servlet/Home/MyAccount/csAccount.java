 ...
 * 我的账号
 */
@WebServlet("/csAccount/*")
public class csAccount extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        if (pathInfo != null) {
            ...
            if (pathInfo.equals("/get")) {
                ...
                if (map != null) {
                    datamap.put("cs_id", map.get("id"));
                    datamap.put("cs_tel", map.get("phone"));
                    datamap.put("cs_img", map.get("img"));
                    datamap.put("cs_name", map.get("name"));
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        if (pathInfo != null) {
            ...
            if (pathInfo.equals("/set")) {
                ...
                map.put("cs_name", dataMap.get("cs_name"));
                map.put("cs_tel", dataMap.get("cs_tel"));
