 ...
 * 我的账号
 */
@WebServlet("/auAccount/*")
public class auAccount extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        if (pathInfo != null) {
            ...
            if (pathInfo.equals("/get")) {
                ...
                Map<String, Object> map = new AuServiceImpl().selectById(id);//根据id来获取
                ...
                if (map != null) {
                    datamap.put("au_id", map.get("id"));
                    datamap.put("au_tel", map.get("phone"));
                    datamap.put("au_img", map.get("img"));
                    datamap.put("au_name", map.get("name"));
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        if (pathInfo != null) {
            ...
            if (pathInfo.equals("/set")) {
                ...
                map.put("au_name", dataMap.get("au_name"));
                map.put("au_tel", dataMap.get("au_tel"));
                ...
                String msg1 = new AuServiceImpl().judgePassword(name,pwd);

                Map<String,Object> map = new HashMap<>();
                map.put("au_id",mj.getValue("id"));
                map.put("au_pwd",newPwd);


                if(msg1.equals("yes")){
                    String msg2 = new AuServiceImpl().update(map);
                    if(msg2==null){
                        jsonObject.put("status", true);
